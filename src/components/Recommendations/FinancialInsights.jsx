...
const FinancialInsights = ({ balance = -420, avgMonthlySpend = 3200 }) => {
  const potentialSaving = Math.max(
    0,
    Math.floor((avgMonthlySpend * 0.1) / 10) * 10
  );
      ...
      text: (
        <>
          <ul className="list-disc pl-5 space-y-2 text-lg">
            <li>
              רוב הסטודנטים בגילך שחיים בשכירות מצליחים לחסוך לפחות 100 ש"ח
              בחודש רק על צמצום הזמנות וולט.
            </li>
            <li>
              3 מתוך 4 משתמשים עם פרופיל דומה התחילו לחסוך בעזרת תזכורת שבועית
              אוטומטית להפקדה לחיסכון.
            </li>
            <li>
              סטודנטים שנרשמו למנוי קבוע בקפיטריה דיווחו על ירידה של כ־20%
              בהוצאות החודשיות על מזון.
            </li>
          </ul>
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md space-y-5">
      ...
      {insights.map((item, i) => {
        ...
        return (
          ...
          >
            ...
            <div className="text-lg text-gray-800 leading-tight">
      ...
      >
        ...
        <div className="mt-2 text-lg font-semibold text-gray-700 border-t pt-2 flex justify-between">
          <span>סה״כ</span>
          <span>₪{total}</span>
        </div>
      </motion.div>
      ...
      >
        ...
        <p className="text-base text-gray-800">
          הוצאת מעל ₪1,000 על מזון – אולי שווה לבדוק מנוי בקפיטריה או בישול
          ביתי. לפעמים שינוי קטן = חיסכון גדול.
        </p>
      </motion.div>
